...
\cventry{\textbf{2024 -- 2025}\\1 an -- Freelance}{Développement Zephyr}{Syslinbit + Semtech}{Grenoble}{}{
  \begin{itemize}
    \item Portage de la stack LoRaWAN Basics Modem sur Zephyr
    \item Implémentation logicielle de la \textit{link-layer} Bluetooth Low Energy
  \end{itemize}
}

\cventry{\textbf{2023 -- 2024}\\1 an -- Freelance}{Conception Linux embarqué}{Syslinbit + Schneider}{Grenoble}{}{
  \begin{itemize}
    \item \textit{Bring-up} U-Boot et Linux dans un environnement embarqué et \textit{rebase} Linux
    \item Développement de drivers Ethernet pour Linux
  \end{itemize}
}
\cventry{\textbf{2023 -- }\\ Freelance}{Conception carte électronique}{Syslinbit + Enerbee}{Grenoble}{}{
  \begin{itemize}
    \item Spécification, conception et réalisation d'une carte électronique alimentée sur batterie
  \end{itemize}
}
\cventry{\textbf{2020 -- 2022}\\2.5 ans -- CDI}{Développement logiciel embarqué et tests}{Kalray}{Grenoble}{}{
  \begin{itemize}
...
\cventry{\textbf{2022}}{Conception électronique}{Elsys Design}{Grenoble}{}{
  \begin{itemize}
    \item Évaluation et design d’une carte satellite capteur de distance "Time Of Flight"
  \end{itemize}
}
\cventry{\textbf{2018 -- 2020}\\1.5 ans -- CDD}{Ingénieur Fablab}{Grenoble INP - Phelma}{Grenoble}{}{
  \begin{itemize}
...
\cventry{\textbf{2017 -- 2018}\\1.5 ans -- CDI}{Développement logiciel Linux \texttt{C++}}{Keepixo}{Meylan}{}{
...
\cventry{\textbf{2014}}{Stage Opérateur}{La Poste}{}{Appli Android de reconnaissance d'images.}{}
